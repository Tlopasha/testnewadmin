...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		...
		<div class="col-md-1 actions">
			@lv_access("Sucursals", "edit")
				<a href="{{ url(config('LaravelVueAdmin.adminRoute') . '/sucursals/'.$sucursal->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endlv_access
			
			@lv_access("Sucursals", "delete")
				{{ Form::open(['route' => [config('LaravelVueAdmin.adminRoute') . '.sucursals.destroy', $sucursal->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('LaravelVueAdmin.adminRoute') . '/sucursals') }}" data-toggle="tooltip" data-placement="right" title="Back to Sucursals"><i class="fa fa-chevron-left"></i></a></li>
