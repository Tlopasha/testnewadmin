...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		...
		<div class="col-md-1 actions">
			@lv_access("Pedicuristas", "edit")
				<a href="{{ url(config('LaravelVueAdmin.adminRoute') . '/pedicuristas/'.$pedicurista->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endlv_access
			
			@lv_access("Pedicuristas", "delete")
				{{ Form::open(['route' => [config('LaravelVueAdmin.adminRoute') . '.pedicuristas.destroy', $pedicurista->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('LaravelVueAdmin.adminRoute') . '/pedicuristas') }}" data-toggle="tooltip" data-placement="right" title="Back to Pedicuristas"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@lv_display($module, 'nombre')
						@lv_display($module, 'apellidop')
						@lv_display($module, 'apellidom')
						@lv_display($module, 'sucursal_id')
					</div>
				</div>
			</div>
		</div>
