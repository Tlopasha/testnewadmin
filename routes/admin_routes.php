...
Route::group(['as' => $as, 'middleware' => ['auth', 'permission:ADMIN_PANEL']], function () {
	...
	// Sucursals //
	Route::resource(config('LaravelVueAdmin.adminRoute') . '/sucursals', 'LaravelVueAdmin\SucursalsController');
	Route::get(config('LaravelVueAdmin.adminRoute') . '/sucursal_dt_ajax', 'LaravelVueAdmin\SucursalsController@dtajax');

	// Pedicuristas //
	Route::resource(config('LaravelVueAdmin.adminRoute') . '/pedicuristas', 'LaravelVueAdmin\PedicuristasController');
	Route::get(config('LaravelVueAdmin.adminRoute') . '/pedicurista_dt_ajax', 'LaravelVueAdmin\PedicuristasController@dtajax');
});
