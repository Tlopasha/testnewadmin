<?php
/**
 * Migration genrated using LaravelVueAdmin
...
class CreatePedicuristasTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Pedicuristas", 'pedicuristas', 'nombre', 'fa-users', [
            ["nombre", "Nombre", "Name", false, "", 0, 256, true],
            ["apellidop", "Apellido Paterno", "Name", false, "", 0, 256, true],
            ["apellidom", "Apellido Materno", "Name", false, "", 0, 256, false],
